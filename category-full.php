...
?>
    <div class="row">
        <section class="category-page style-3 large-12 medium-12 small-12 left">
            <?php if (have_posts()): ?>
                <div class="column page-header">
                    <article>
                        <h3 class="page-title"><?php printf( __( 'Category Archives: %s', 'incir'), single_cat_title( '', false ) ); ?></h3>
                    </article>
                </div><!-- .page-header -->
